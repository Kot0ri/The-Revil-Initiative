...
PixelShader =
{
	...
	[[
		...
		float4 main( VS_OUTPUT_PDXMESHSTANDARD In ) : PDX_COLOR
		{
			...
			float alpha = 0.0f;
		#ifdef EMISSIVE
            #ifdef PERMA_EMISSIVE
			    float vDayNightFactor = 1.0f;
            #else
...
# added for mod
Effect PdxMeshAdvancedCustom
{
	VertexShader = "VertexPdxMeshStandard"
	PixelShader = "PixelPdxMeshStandard"
	Defines = { "EMISSIVE" "PERMA_EMISSIVE" "PDX_IMPROVED_BLINN_PHONG" "RIM_LIGHT" }
}
Effect PdxMeshAdvancedCustomSkinned
{
	VertexShader = "VertexPdxMeshStandardSkinned"
	PixelShader = "PixelPdxMeshStandard"
	Defines = { "EMISSIVE" "PERMA_EMISSIVE" "PDX_IMPROVED_BLINN_PHONG" "ATLAS" "RIM_LIGHT"  }
}
Effect PdxMeshAdvancedCustomShadow
{
	VertexShader = "VertexPdxMeshStandardShadow"
	PixelShader = "PixelPdxMeshStandardShadow"
}

Effect PdxMeshAdvancedCustomSkinnedShadow
{
	VertexShader = "VertexPdxMeshStandardSkinnedShadow"
	PixelShader = "PixelPdxMeshStandardShadow"
}
Effect PdxMeshAdvancedCustomSnow
{
	VertexShader = "VertexPdxMeshStandard"
	PixelShader = "PixelPdxMeshStandard"
	Defines = { "EMISSIVE" "PERMA_EMISSIVE" "PDX_IMPROVED_BLINN_PHONG" "RIM_LIGHT" "PDX_SNOW" "PDX_GRADIENT_BORDERS" }
}
Effect PdxMeshAdvancedCustomSnowSkinned
{
	VertexShader = "VertexPdxMeshStandardSkinned"
	PixelShader = "PixelPdxMeshStandard"
	Defines = { "EMISSIVE" "PERMA_EMISSIVE" "PDX_IMPROVED_BLINN_PHONG" "ATLAS" "PDX_SNOW" "RIM_LIGHT"  }
}
Effect PdxMeshAdvancedCustomSnowShadow
{
	VertexShader = "VertexPdxMeshStandardShadow"
	PixelShader = "PixelPdxMeshStandardShadow"
}
Effect PdxMeshAdvancedCustomSnowSkinnedShadow
{
	VertexShader = "VertexPdxMeshStandardSkinnedShadow"
	PixelShader = "PixelPdxMeshStandardShadow"
}
